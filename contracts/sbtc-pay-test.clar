;; ============================================================================
;; sbtc-pay-test.clar - TEST-ONLY VARIANT of sbtc-pay-mainnet.clar
;; ============================================================================
;; DO NOT DEPLOY TO MAINNET. This file exists exclusively to back simnet
;; refund + payment tests against a mock SIP-010 token.
;;
;; Byte-for-byte identical to contracts/sbtc-pay-mainnet.clar EXCEPT every
;; reference to the production sBTC principal
;;
;;     'SM3VDXK3WZZSA84XXFKAFAF15NNZX32CTSG82JFQ4.sbtc-token
;;
;; has been substituted with the relative-name reference
;;
;;     .mock-sbtc-token
;;
;; so that sBTC transfer calls hit the mock contract (deployed alongside
;; this one in simnet). Six call sites are substituted: the SBTC_CONTRACT
;; constant and five contract-call? sites for payments / refunds / direct
;; payments. Every other line is preserved exactly so the test variant
;; exercises the same authorization, accounting, status-transition, and
;; event-emission logic as the production contract.
;;
;; Mainnet deploys continue to use sbtc-pay-mainnet.clar.
;; ============================================================================
...
;; sBTC token contract (MAINNET - change for mainnet)
(define-constant SBTC_CONTRACT .mock-sbtc-token)
