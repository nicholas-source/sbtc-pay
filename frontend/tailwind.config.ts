  ...
  theme: {
    ...
    extend: {
      ...
      fontSize: {
        ...
        "heading-lg": ["2.25rem", { lineHeight: "1.15", letterSpacing: "-0.01em", fontWeight: "600" }],
        "heading": ["1.875rem", { lineHeight: "1.2", letterSpacing: "-0.01em", fontWeight: "600" }],
        "heading-sm": ["1.5rem", { lineHeight: "1.25", letterSpacing: "-0.005em", fontWeight: "600" }],
        "body-lg": ["1.125rem", { lineHeight: "1.6", fontWeight: "400" }],
        "body": ["1rem", { lineHeight: "1.6", fontWeight: "400" }],
        "body-sm": ["0.875rem", { lineHeight: "1.5", fontWeight: "400" }],
        "caption": ["0.75rem", { lineHeight: "1.4", fontWeight: "500" }],
        "sats": ["2rem", { lineHeight: "1", letterSpacing: "-0.02em", fontWeight: "700" }],
      },
      colors: {
