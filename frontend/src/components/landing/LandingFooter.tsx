...
const footerLinks = {
  Product: [
    ...
    { label: "Widget Generator", href: "/dashboard/widget" },
  ],
  Resources: [
        ...
        <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 sm:gap-6 md:gap-8" style={{ gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))' }}>
          ...
          <div className="col-span-2 md:col-span-1 flex flex-col gap-space-md">
            ...
            <p className="text-body-sm text-muted-foreground max-w-xs">
              Enterprise-grade Bitcoin payment infrastructure. Built on Stacks, secured by Bitcoin.
            </p>
            <div className="flex items-center gap-4">
              {/* Twitter/X */}
              <a href="https://x.com/sbtcpay" target="_blank" rel="noopener noreferrer" aria-label="Twitter" className="text-muted-foreground hover:text-foreground transition-colors">
                <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg>
              </a>
              {/* GitHub */}
              <a href="https://github.com/nicholas-source/sbtc-pay" target="_blank" rel="noopener noreferrer" aria-label="GitHub" className="text-muted-foreground hover:text-foreground transition-colors">
              ...
              {/* Discord */}
              <a href="https://discord.gg/stacks" target="_blank" rel="noopener noreferrer" aria-label="Discord" className="text-muted-foreground hover:text-foreground transition-colors">
